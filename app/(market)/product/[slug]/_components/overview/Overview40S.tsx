...
const useCases = [
  'Construction Sites', 'Business Storage', 'Warehouse Overflow', 'Fleet & Equipment',
  'Wholesale Storage', 'Distribution Staging', 'Whole-Home Moving', 'Farm & Agriculture',
  'Event Storage', 'Retail Overflow',
]
