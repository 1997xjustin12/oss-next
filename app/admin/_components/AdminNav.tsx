...
import { Bot, DatabaseZap, FileCog, Inbox, LayoutPanelTop, MessagesSquare, Type } from 'lucide-react';
...
const ICONS = { FileCog, Type, Bot, Inbox, DatabaseZap, MessagesSquare, LayoutPanelTop } as const;
